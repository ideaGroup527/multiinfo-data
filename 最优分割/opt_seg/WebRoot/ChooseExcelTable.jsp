					...
					<div id="featured-wrapper">
						...
						<div id="featured-content">
							<h2 class="bottom-border"> 
								您选择的Excel文件是{Your File}：${fileShortName } 
							</h2>
							...
							<form method="POST" action="chooseExcelTable">
								...
								<table class="stock" width="221" border="0">
									...
									<thead>
										<tr class="even">
											<th width="275"> 
												选择您所需的表格<br>{sign column} 
											</th>
										</tr>
										<c:set var="flagi" value="0"></c:set>
											<c:forEach var="i" items="${sheetNames}">
											<tr class="even">
												<td width="275">
													<input type="radio" name="sheetName" value="${flagi }" />
													${i }
												</td>
