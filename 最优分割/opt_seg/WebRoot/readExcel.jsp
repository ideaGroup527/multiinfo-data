					...
					<div id="featured-wrapper">
						...
						<div id="featured-content">
							<h2 class="bottom-border"> 
								选择所需的Excel表{Choose excel file} 
							</h2>
							<center>
								<form method="POST" action="readExcel" enctype="multipart/form-data">
									<table class="stock" width="384" border="0" height="71">
										<thead>
											<tr>
												<th width="150">
													选择Excel文件：<br>{excel file}
												</th>
												<th width="200">
													<div align="center">
														<input type="file" name="excelPath" size="15" onChange="getWorkBook()">
													</div>
												</th>
											</tr>
										</thead>
				...
				<div id="left-column">
					...
					<p>
						<a href="#"><img class="left"
								style="width: 51px; height: 41px;" alt=""
