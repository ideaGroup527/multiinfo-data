...
<script>
		...
		<center>
			<h2>
				折线图数据选择第二步</h2>
			<br>
			<h3>所选的工作表是：<span class="STYLE1">${picName }</span></h3>
		</center>
		<br>
		<br>
		<form method="post" action="XYDisperse">
		<input type="hidden" name="tran" value="${tran }">
		  ...
		  <table  border="1" align="center" width="620" >
				...
				<tr>
					...
					<td>
						<p align="center">
							<input type="radio" value="true" name="orient">
							是
							<input type="radio" value="false" name="orient" checked>
					否					</td>
				</tr>
				<tr>
					<td width="47%" colspan="3">
				...
				<tr>
					<td colspan="3">
						背景上部颜色
						<input type="text" name="upBackColor" size="9" style="background:#99CCFF" value="#99CCFF"
							onclick="$(this).colorPicker()" readonly/>
					</td>
					<td>
						背景下部颜色
						<input type="text" name="downBackColor" size="9" style="background:#99CCFF"  value="#99CCFF"
							onclick="$(this).colorPicker()" readonly/>
					</td>
				</tr>
				<tr>
					...
					<td width="21%">
						字体<select size="1" name="titleFont">
					...
					<td>
						颜色
						<input type="text" name="titleColor" size="9" style="background:#3366FF" value="#3366FF"
							onclick="$(this).colorPicker()" readonly/>
					</td>
				</tr>
				<tr>
					...
					<td>
						颜色
						<input type="text" name="xColor" size="9" style="background:#3366FF" value="#3366FF"
							onclick="$(this).colorPicker()" readonly/>
					</td>
				</tr>
				<tr>
					...
					<td>
						颜色
						<input type="text" name="yColor" size="9" style="background:#3366FF" value="#3366FF"
							onclick="$(this).colorPicker()" readonly/>
					</td>
				</tr>
